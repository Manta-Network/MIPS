...
To generate this transfer transactions, `GenTransfer` takes the following informations
(including secrets) of the two old coins: 
  ...
  -  &pi;<sub>transfer</sub>: a zero-knowlege proof to proof the validity of the transfer.  
